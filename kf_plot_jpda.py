...
plt.subplot(3, 1, 1)
plt.plot(time_list, r_list, color='lime', linewidth=2)  # Adjust line color and width
...
#plt.legend(loc='upper right', fontsize='small', facecolor='black', edgecolor='white')
plt.legend()
...
plt.grid(color='gray', linestyle='--')
#plt.legend(loc='upper right', fontsize='small', facecolor='grey', edgecolor='white')
plt.legend()
